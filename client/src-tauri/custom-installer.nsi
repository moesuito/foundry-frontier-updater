...
Function FinishPageShow
  ; Find the inner dialog of the finish page (ID 1044 is the standard client area)
  FindWindow $1 "#32770" "" $HWNDPARENT
  
  ; Create "Inicializar com o Windows" checkbox
  ; Coordinates: X=120, Y=175, Width=300, Height=20 (in pixels)
  ; Checkbox style: 0x50010003 (WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_AUTOCHECKBOX)
  System::Call 'USER32::CreateWindowEx(i 0, t "BUTTON", t "Inicializar com o Windows", i 0x50010003, i 120, i 175, i 300, i 20, i$1, i 0, i 0, i 0) i.r0'
  StrCpy $AutoStartCheckbox $0
  
  ; Set the font to match the parent dialog's font
  SendMessage $HWNDPARENT 0x0031 0 0 $2 ; WM_GETFONT
  SendMessage $AutoStartCheckbox 0x0030 $2 1 ; WM_SETFONT
  
  ; Check it by default
  SendMessage $AutoStartCheckbox 0x00F1 1 0 ; BM_SETCHECK (BST_CHECKED = 1)
FunctionEnd

Function FinishPageLeave
  SendMessage $AutoStartCheckbox 0x00F0 0 0 $0 ; BM_GETCHECK
  StrCpy $AutoStartCheckboxState $0
FunctionEnd
...
Section Install
  ...
  check_ns_flag:
    ...
    IfErrors 0 shortcuts_done
      ...
      CreateShortcut "$APPDATA\Microsoft\Windows\Start Menu\Programs\Startup\FoundryFrontierSync.lnk" "$INSTDIR\${MAINBINARYNAME}.exe" "--background --tray"
      !insertmacro SetLnkAppUserModelId "$APPDATA\Microsoft\Windows\Start Menu\Programs\Startup\FoundryFrontierSync.lnk"
  shortcuts_done:
...
Function .onInstSuccess
  ...
  ; Create startup shortcut if checked in the GUI finish page
